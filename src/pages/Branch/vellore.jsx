...
import DEVNAYAGI from "@/assets/branch/vellore/DEVNAYAGI.webp";
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                >
                  ...
                  <p className="text-base sm:text-lg md:text-xl mt-4">
                    PERSONALIZED FERTILITY SOLUTIONS FOR YOUR UNIQUE JOURNEY
                  </p>
            ...
            <div className="w-full p-5">
              ...
              <ScrollMotion>
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md font-bold">
                        Best Fertility Centre in Vellore{" "}
                      </p>
                      <p className="text-md mt-3 text-md text-[#838383]">
                        In 2022, Sudha Fertility Centre brought its renowned
                        fertility services to Vellore. As the leading fertility
                        hospital in Vellore, we are committed to offering
                        personalised, compassionate care to guide you on your
                        journey to parenthood. Our experienced team is dedicated
                        to supporting you every step of the way, helping you
                      ...
                      <p className="mt-2 text-md text-md text-[#838383]">
                        Sudha Fertility Centre in Vellore is home to the best
                        fertility specialists, offering personalised treatments
                        designed to help you overcome infertility. Our
                        expert-led fertility hospital is equipped with
                        cutting-edge technologies to support your dreams of
                        parenthood.
                      </p>
                    </div>
                    <div className="w-full lg:w-1/2">
                  ...
                  >
                    <p className="mt-2 text-md text-md text-[#838383]">
                      As the best IVF centre in Vellore, Sudha Fertility Centre
                    ...
                    <p className="text-md text-[#838383]">
                      ...
                      the best fertility doctors in Vellore.
                    </p>
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      At Sudha Fertility Centre, we have had the honour of
                      helping many families overcome the obstacles of
                      conception. Every family that arrives with hope in their
                      hearts receives compassionate care, and it fills us with
                      joy to witness parents holding their newborn for the first
                      time. Our success stories in Vellore span a wide range,
                      from young couples to older couples eager to start their
                      journey to parenthood.
                    </p>
                    <p className="text-md text-[#838383]">
                      Sudha Fertility Centre in Vellore is known for
                      consistently offering hope and joy to families facing
                      complex fertility challenges, providing effective
                      solutions that make dreams come true. Under the guidance
                      of the best fertility and IVF specialists in Vellore,
                      couples who have longed for a child have been blessed with
                      babies, fulfilling their parenthood dreams at Sudha
                      Fertility Centre.
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        As the premier fertility hospital in Vellore, Sudha
                        Fertility Centre delivers prompt and effective solutions
                        based on solid evidence. We help turn your dream of
                        parenthood into reality with our advanced fertility
                        treatments and exceptional facilities, ensuring
                        excellence throughout your journey
                      </p>
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <h3 className="text-[20px] font-bold mt-2">
                        Chief Experts of Sudha Fertility Centre in Trichy
                      </h3>
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      <h2 className="text-[20px] font-bold">
                        Our Fertility Specialist in Vellore
                      </h2>
                      <h2 className="text-[18px] text-[#173366] font-bold mt-2">
                        Dr. M. Ayswariya
                      </h2>
                      <h2 className="text-md text-[#000000] mt-2">
                        MBBS MS ( OG ), DNB (OG), FICOG(RM) - Fertility
                        Consultant / Gynaecologist{" "}
                      </h2>
                      <p className="text-md text-[#838383] mt-2">
                        Dr.M.Ayswariya is a Fertility Consultant/Gynaecologist
                        at Sudha Fertility Center, Vellore. She completed, MBBS
                        MS ( OG ), DNB (OG), and FICOG(RM) She has done more
                        than 500 ICSI and 1000 IUI procedures.
                      </p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <h2 className="text-md text-[#000000]">
                        MBBS, MS(OG) - Gynaecologist{" "}
                      </h2>
                      <p className="text-md text-[#838383] mt-2">
                        Dr. M. Devanayagi, gynaecologist at Sudha Fertility
                        Centre, Vellore. She completed MBBS.MS (OG). She
                        consulted more than 5000 patients & moreover, and the
                        antenatal mothers were happy with her advice throughout
                        their pregnancy journey. The doctor has completed more
                        than 150 hysteroscopy and laparoscopy & other
                        procedures. She completed more than 30 high-risk
                        deliveries and has expertise in instrumental deliveries.
                        Dr.M.Devanayagi has been working for 2 years in Sudha
                        hospitals. Excellent performance within that Profession.
                      </p>
                    </div>
                  </motion.div>
                      ...
                      <div className="bg-blue-50 p-6 rounded-lg space-y-6">
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-lg sm:text-xl md:text-sm  font-bold">
                            24, 4th East Cross Rd, Suthanthira Ponvizha Nagar, Gandhi Nagar, Vellore, Tamil Nadu 632006
                            </p>
                          </div>
                        </div>
