...
function TrichyPage() {
  ...
  const toggleViewMore = () => {
    if (showAll) {
      ...
      setVisibleCount(Trichy.faqs.length); // Show all FAQs
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="mt-2 text-md text-md text-[#838383]">
                        Offering exceptional fertility treatments in Trichy,
                        Sudha Fertility Centre is renowned for providing expert
                        fertility services. Our dedicated specialists are
                        committed to helping you overcome infertility, offering
                        personalised treatments to support your path to becoming
                        a parent.
                      </p>
                    </div>
                    <div className="w-full lg:w-1/2">
                  ...
                  >
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      At Sudha Fertility Centre in Trichy, we have brightened
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        Sudha Fertility Centre in Trichy offers a warm and
                        supportive environment and cutting-edge fertility
                        treatments to help couples on their journey to
                        parenthood. Our goal is to turn your dream of parenthood
                        into a reality through advanced fertility treatments and
                        state-of-the-art facilities, ensuring excellence at
                        every step of your journey.
                      </p>
                      <ul className="text-md text-[#838383] mt-2 list-disc pl-4 line-height-10">
                        <li>State-of-the-art Operation theatres (OTs) </li>
                        ...
                        <li>Well-equipped scan rooms </li>
                ...
                <section id="specialists">
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        Dr. Uma Shankari, MBBS, DGO, serves as a Fertility
                        Consultant/Gynecologist at Sudha Fertility Centre,
                        Trichy. With extensive experience spanning 5 years, she
                        has performed over 1200 ICSI, 1200 IUI, and 900 IVF
                        procedures, earning praise from over 10,000 satisfied
                        patients. Dr. Shankari’s expertise also extends to
                        completing more than 500 laparoscopic, 300
              ...
              <ScrollMotion>
                <section id="gallery">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <ImageGrid images={Trichy.gallery} />
                  </motion.div>
      ...
      <div className="container mx-auto">
        <section>
          <div className="max-w-2xl mx-auto p-4">
            ...
            {Trichy.faqs.slice(0, visibleCount).map((faq, index) => (
              <FAQItem
                key={index}
            ...
            {Trichy.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
