...
import { Dindigul } from "@/middleware/imagesroute";
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                >
                  ...
                  <p className="text-base sm:text-lg md:text-xl mt-4">
                    GUIDING YOU THROUGH THE JOY OF PARENTHOOD!
                  </p>
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md mt-3 text-[#838383]">
                        Since 2023, Sudha Fertility Centre has been a trusted
                        name in Dindigul, providing couples with the best
                        fertility care and treatments. Known as the leading
                        fertility hospital in Dindigul, we combine advanced
                        techniques with individualized care to support your path
                        to parenthood. With years of expertise, our dedicated
                        doctors are passionate about helping you achieve your
                        dream.
                      </p>
                  ...
                  >
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      At Sudha Fertility Centre in Dindigul, we are passionate
                      about helping families achieve their dream of parenthood
                      through expert fertility care. As the leading IVF hospital
                      in the region, we’ve assisted countless couples, from
                      young newlyweds to older couples yearning for a child,
                      turning their hopes into reality. Our consistent success
                      in delivering lakhs of healthy babies across all branches
                      is a testament to our dedication and expertise. We are
                      proud to be recognized as Dindigul’s top fertility centre.
                    </p>
                    <p className="text-md text-[#838383] mt-3">
                      At Sudha Fertility Centre, we are committed to providing
                      not only the most advanced fertility treatments but also
                      emotional support to every couple. Our team of top IVF
                      doctors works closely with patients, offering personalized
                      care that addresses their unique fertility needs. We
                      understand the challenges that couples face and are here
                      to provide guidance, reassurance, and the highest level of
                      care. Through our patient-focused approach, we aim to help
                      couples experience the incredible joy of parenthood,
                      bringing their dreams to life with expert treatments and
                      compassionate care
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        Being the best fertility hospital in Dindigul, we offer
                        you quality fertility treatments with experienced
                        fertility specialists, world-class facilities,
                        state-of-the-art technology, expert gynecologists, and
                    ...
                    <div className="w-full lg:w-1/2">
                      <ImageSlider images={Dindigul.gallery} />
                ...
                <section id="specialists">
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      MBBS., MS(OG) - Fertility Consultant / OBGYN 
                      </h2>
                      <p className="text-md text-[#838383] mt-2">
                      Dr. Nadiya Hameed Farooq, MS in Obstetrics & Gynecology from Sree Mookambika Institute of Medical Science, Kanyakumari, serves as a Fertility Consultant/OBGYN at Sudha Fertility Centre, Dindigul Branch. With expertise in fertility treatments, including over 100 successful IUI procedures, Dr. Farooq is recognized for her compassionate care and personalized approach, providing both medical expertise and emotional support to her patients.
                      </p>
                    </div>
                  </motion.div>
