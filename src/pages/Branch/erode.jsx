              ...
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                >
                  ...
                  <p className="text-base sm:text-lg md:text-xl mt-4">
                    WHERE BEAUTIFUL JOURNEYS TO MOTHERHOOD BEGIN!
                  </p>
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    ...
                    <p className="text-md text-[#838383]">
                      ...
                      the best fertility doctors in Erode.
                    </p>
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      For years, Sudha Fertility Centre has been a beacon for
                      families in Erode, including young couples beginning their
                      journey together and older couples longing for a baby. Our
                      commitment and determination to provide exceptional care
                      and the best treatments set us apart as the leading IVF
                      hospital in Erode. We make sure your parenthood is no more
                      a dream.
                    </p>
                    <p className="text-md text-[#838383] mt-3">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <ul className="text-md text-[#838383] mt-2 list-disc pl-4 line-height-10">
                        ...
                        <li>30 Intensive Care Unit (ICU) beds </li>
                        ...
                        <li>Feeding rooms </li>
                        <li>
                          Cost-efficient procedures and personalised treatment
                          plans
                        </li>
                      </ul>
                    </div>
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        ...
                        Fertility Centre. With extensive experience in women’s
                        health, Dr. Vanitha specialises in prenatal care,
                        gynecological treatments, and reproductive health. She
                        is dedicated to providing personalised and expert care,
                        ensuring the well-being of every patient making her an
                        invaluable asset to Sudha Fertility Centre.
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
