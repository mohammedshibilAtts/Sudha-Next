...
import Rajashree from "@/assets/branch/tiruvannamalai/Rajashree.webp";
...
function TiruvannamalaiPage() {
  ...
  const toggleViewMore = () => {
    if (showAll) {
      ...
      setVisibleCount(Tiruvannamalai.faqs.length); // Show all FAQs
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md mt-3 text-md text-[#838383]">
                        ...
                        a common issue. But it still affects the lives of many
                        families. Each case has unique challenges, and finding
                        the root cause of the problem is crucial. With the right
                        support, you can make your dream of parenthood a
                        reality. From young to older couples, our success story
                        is marked by consistently high success.
                      </p>
                      <h5 className="mt-2 font-bold">
                        Best Fertility Treatments in Tiruvannamalai
                      </h5>
                      <p className="mt-2 text-md text-md text-[#838383]">
                        As a leading IVF Centre in Tiruvannamalai, we offer
                        advanced IVF treatments and other reproductive
                        technologies to support your journey to parenthood. Our
                        experienced specialists and state-of-the-art facilities
                        are dedicated to offering you the best care and support.
                      </p>
                    </div>
                    <div className="w-full lg:w-1/2">
                      <Image
                  ...
                  >
                    ...
                    <p className="text-md text-[#838383]">
                      ...
                      the best fertility doctors in Tiruvannamalai.
                    </p>
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      We understand the emotional and physical challenges you go
                      through facing infertility issues. At our fertility
                      hospital in Tiruvannamalai, our compassionate and
                      dedicated team is committed to guiding you through every
                      step of your parenthood journey with personalized support
                      and expert care.
                    </p>
                    <p className="text-md text-[#838383]">
                      As the best IVF hospital in Tiruvannamalai, we promise to
                      make your journey to becoming a parent as hopeful and
                      successful as possible. Let us help you turn your dreams
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        Known as the best fertility hospital in Tiruvannamalai,
                        Sudha Fertility Centre integrates state-of-the-art
                        technology with compassionate care. Our commitment is to
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        ...
                        fertility care with empathy and precision, ensuring
                        every couple receives the best possible support on their
              ...
              <ScrollMotion>
                <section id="gallery">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <ImageGrid images={Tiruvannamalai.gallery} />
                  </motion.div>
      ...
      <div className="container mx-auto">
        <section>
          <div className="max-w-2xl mx-auto p-4">
            ...
            {Tiruvannamalai.faqs.slice(0, visibleCount).map((faq, index) => (
              <FAQItem
                key={index}
            ...
            {Tiruvannamalai.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
...
export default TiruvannamalaiPage;
