                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      At Sudha Fertility Centre in Nagercoil, we proudly hold
                      the reputation of being the best IVF hospital,
                      transforming the dreams of thousands of couples into
                      reality. From young newlyweds envisioning their future
                      family to older couples who have waited years to hold a
                      child, we’ve become a beacon of hope for many. With a
                      legacy of delivering lakhs of healthy babies across our
                      branches, we remain committed to our mission as
                      Nagercoil’s leading fertility centre.
                    </p>
                    <p className="text-md text-[#838383]">
                      Our expert team is dedicated to offering the highest
                      quality fertility care with a personal touch. At Sudha
                      Fertility Centre, we understand that each couple’s journey
                      is unique, and we provide customized treatment plans that
                      address their individual needs. Guided by the finest IVF
                      specialists, we combine advanced technology with
                      compassionate care to support couples every step of the
                      way. Our goal is to make the dream of parenthood a joyful
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        ...
                        dedicated specialist at Sudha Fertility Centre. With
                        extensive experience in women’s health and fertility
                        care, she is committed to offering compassionate,
                        evidence-based treatments to support couples on their
                        path to parenthood, ensuring the highest standards of
