...
import PraneethaGarlapati from "@/assets/branch/vijayawada/PraneethaGarlapati.webp";
...
function VijayawadaPage() {
  ...
  const toggleViewMore = () => {
    if (showAll) {
      ...
      setVisibleCount(Vijayawada.faqs.length); // Show all FAQs
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                >
                  ...
                  <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mt-4">
                    ...
                    <span className="text-[#FDCB58]">Vijayawada</span>
                  </h1>
                  <p className="text-base sm:text-lg md:text-xl mt-4">
                    YOUR TRUSTED GUIDE IN RAISING AMAZING KIDS
                  </p>
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md mt-3 text-md text-[#838383]">
                        ...
                        offering unmatched fertility care. Recognized as the top
                        fertility hospital in Vijayawada, we provide
                        personalised and compassionate support to guide you at
                        every stage of your parenthood journey. Our goal is to
                        help turn your dreams of having a family into reality.
                      </p>
                      <p className="text-md mt-3 text-md text-[#838383]">
                        With our experienced team, we are dedicated to providing
                        the best fertility treatments with compassionate care
                        and support at every step of your parenthood journey.
                      </p>
                      <h5 className="mt-2 font-bold">
                        Best Fertility Treatments in Vijayawada:
                      </h5>
                      <p className="mt-2 text-md text-md text-[#838383]">
                        Equipped with the latest technology and a team of highly
                        skilled fertility specialists in Vijayawada, we deliver
                        advanced fertility treatments in Vijayawada to support
                  ...
                  >
                    ...
                    <p className="text-md text-[#838383]">
                      ...
                      the best fertility doctors in Vijayawada.
                    </p>
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      Sudha Fertility Centre in Vijayawada has brought joy to
                      countless families, fulfilling the dreams of those who
                      have longed for a child. From young couples starting their
                      life together to older couples longing for a child, we
                      have been a part of their beautiful journey. As the
                      leading IVF hospital in Vijayawada, we are committed to
                      providing outstanding care and ensuring that every
                      individual enjoys a fulfilling parenthood experience.
                    </p>
                    <p className="text-md text-[#838383]">
                      At Sudha Fertility Centre, our mission is to support
                      couples in their parenthood journey with the guidance of
                      the best IVF doctors in Vijayawada. With a remarkable
                      history of delivering lakhs of healthy babies at our
                      various branches, we are honored to be known as the best
                      fertility centre in Vijayawada.
                    </p>
                  </motion.div>
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        Sudha Fertility Centre in Vijayawada offers the best
                        fertility treatments. With the world-class facilities
                        and best fertility experts in Vijayawada, we are known
                        as the best fertility hospital in Vijayawada.
                      </p>
                      <ul className="text-md text-[#838383] mt-2 list-disc pl-4 line-height-10">
                        <li>State-of-the-art IVF Laboratories </li>
                        <li>24/7 Access to Pharmacy</li>
                        <li>Round-the-Clock Care </li>
                        <li>Experienced Fertility Doctors </li>
                        <li>Well Equipped Operation Theatre </li>
                        <li>Personalised Treatment Plans </li>
                        <li>Cost-efficient Procedures and Treatments.</li>
                        <li>Cutting-edge Diagnostic Facilities</li>
                      </ul>
                    </div>
                    <div className="w-full lg:w-1/2">
                ...
                <section id="specialists">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <h3 className="text-[20px] font-bold mt-2">
                        Chief Experts of Sudha Fertility Centre in Vijayawada
                      </h3>
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2">
                      ...
                      <p className="text-md text-[#838383] mt-2">
                        Dr. Praneetha Garlapati, M.B.B.S., M.S.(OG), FRM, is a
                        leading consultant at Sudha Fertility Centre. With a
                        passion for women’s health and fertility treatments, she
                        offers personalized care, empowering couples through
                        their journey to conception and motherhood.
                      </p>
                    </div>
                  </motion.div>
              ...
              <ScrollMotion>
                <section id="gallery">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.5 }}
                  >
                    <ImageGrid images={Vijayawada.gallery} />
                  </motion.div>
      ...
      <div className="container mx-auto">
        <section>
          <div className="max-w-2xl mx-auto p-4">
            ...
            {Vijayawada.faqs.slice(0, visibleCount).map((faq, index) => (
              <FAQItem
                key={index}
            ...
            {Vijayawada.faqs.length > 5 && ( // Ensure button is shown if there are more than 5 FAQs
