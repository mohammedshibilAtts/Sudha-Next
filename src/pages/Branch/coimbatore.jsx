              ...
              <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                >
                  ...
                  <p className="text-base sm:text-lg md:text-xl mt-4">
                    BRINGING OUT THE BEST IN YOUR PARENTHOOD JOURNEY!
                  </p>
                ...
                <section id="about" className="  pt-2">
                  ...
                  >
                    ...
                    <p className="text-md text-[#838383]">
                      ...
                      the best fertility doctors in Coimbatore.
                    </p>
                    ...
                    <p className="text-md text-[#838383] mt-3">
                      At Sudha Fertility Centre, we understand the emotional
                      challenges associated with fertility issues, and our
                      dedicated support staff is here to guide you through every
                      step. With a focus on innovation and patient well-being,
                      we strive to redefine possibilities in reproductive
                      healthcare. As the best IVF hospital in Coimbatore, we
                      provide fertility treatments for couples of all age
                      categories and make your parenthood dream a reality.
                    </p>
                    <p className="text-md text-[#838383] mt-3">
                  ...
                  >
                    <div className="w-full lg:w-1/2">
                      ...
                      <h4 className="text-md text-[#000000]">
                        MD (OG) Senior Consultant IVF & ART Specialist
                      </h4>
                      <p className="text-md text-[#838383] mt-2 line-height-10">
                        Dr. Dhanabagyam, a visionary in fertility and women’s
                        health, harbored a profound vision to create a
                        pioneering women’s care and fertility centre offering
                        unparalleled treatments at affordable prices. Driven by
                        this visionary goal, the first Sudha Fertility Centre
                        was begun in 1995 in Erode. Under her exceptional
                        guidance and expertise, the centre has flourished into a
                        network of over 22+ highly successful branches across
